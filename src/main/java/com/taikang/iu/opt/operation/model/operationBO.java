package com.taikang.iu.opt.operation.model;
...
public class operationBO  extends BaseBO {
	...
	protected void init(){
		super.init();
		this.addList(Arrays.asList("site","complain_id","complain_num","complain_name","complain_tel","complain_msg","dispose_msg","sub_order","complain_type","complain_state","dispose_name","dispose_time","created_time","created_by","modified_time","modified_by","version","delflag"));
	}

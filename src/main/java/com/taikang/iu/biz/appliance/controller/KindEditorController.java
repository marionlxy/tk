...
@Controller
@RequestMapping("/main/kindeditor")
public class KindEditorController {
	...
	public void fileUpload(HttpServletRequest  request,
		...
		// 文件保存目录URL
		String saveUrl = "http://localhost:8080/opt/main/kindeditor/";
...
//		String rootPath = this.publicInfo.getdisc();
//		// 根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/attached/
//		String rootUrl =  getServerPath(request)+"/";
//		// 图片扩展名
...
//	}
	...
	public void fileUpload(HttpServletRequest  request,
		...
		ServletContext application = request.getSession().getServletContext();
		String savePath = Constants.UPLOAD_IMAGE_PATHS;// + "attached/";

		// 文件保存目录URL
		String saveUrl = "http://localhost:8090/opt/main/kindeditor/";
...
//				}
				...
				String newFileName =  "aa." + fileExt;
				//publicInfo.insertImage()+"";
				try {

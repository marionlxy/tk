...
public class Digests {
	 ...
	 * @throws TKCheckedException 
	 */
	private static byte[] digest(byte[] input, String algorithm, byte[] salt, int iterations) throws TKCheckedException {
		try {
	...
	private static byte[] digest(InputStream input, String algorithm) throws IOException, TKCheckedException {
		try {

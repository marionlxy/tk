...
<!-- 	    	<input class="easyui-combobox" name="complainMsg" style="width:100px" panelHeight="auto" -->
<%-- 		 	url="${rootPath}/getDictCombox?dictType=MultiState" valueField="dictId" textField="dictName" disabled> --%>
		</div>
<!-- 	 	<div class="fitem"> -->
<!-- 	    	<label>投诉状态:</label> -->
<!-- 	    	<input class="easyui-combobox" name="complainState" style="width:100px" panelHeight="auto" -->
<%-- 		 	url="${rootPath}/getDictCombox?dictType=complainstage" valueField="dictId" textField="dictName" disabled> --%>
<!-- 		</div>  -->
		<div class="fitem">
	    	<label>投诉类型:</label>
...
jQuery(function(){ 
	...
	if (complainId != null && complainId != "" && complainId!=0){
		var url='${rootPath}/operation/getOne?complainId=' + complainId;

...
<body>
	<div>
		...
		<form id="dataForm">
			...
			<textarea name="complainMsg" style=" border:1px solid #99bbe8;"  rows="4" cols="31" class="easyui-validatebox" validType="length[0,200]" required="required" readonly="true" ></textarea>
			</div>
<!-- 			<div class="fitem"> -->
<!-- 			<label>投诉状态:</label> -->
...
<!-- 			<textarea name="subOrder" style=" border:1px solid #99bbe8;"  rows="4" cols="33" disabled></textarea> -->
			...
			<div class="fitem">
	    	<label>处理意见:</label>
	    	<textarea name="disposeMsg" style=" border:1px solid #99bbe8;width: 201px"  rows="4" cols="33" ></textarea>
		</div>

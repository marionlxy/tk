...
<div>
    ...
    <div id="dlg-buttons" align="center">
       <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" id="save11" onclick="saveOrUpdate11()" style="width:90px">提交</a>
...
function saveOrUpdate11()
{
	...
	{		
		...
		$.post("${rootPath}/fixed/saveLink",$("#dataForm22").serializeArray(),
		function(data)
		{			

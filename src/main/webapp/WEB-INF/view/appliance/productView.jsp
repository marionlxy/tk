...
<div id="tt" class="easyui-tabs" style="width:100%;">  
	...
	<form id="dataForm1">
		...
		<div class="fitem" id="divTab1">
	    	<label>用品类别:</label>
	        <input name="categoryId"  id="cc" class="easyui-combotree" data-options="url:'${rootPath}/goodscategory/getCategoryComboTree',method:'get',required:true" style="width:205px;" disabled>
	    </div>
		...
		<div class="fitem">
	        ...
	        <input name="applianceSettlePrice" class="easyui-numberbox"  precision="2" groupSeparator="," decimalSeparator="." 
	        												prefix="￥" validType="length[0,12]" required="required" disabled></input>
		</div>
	    ...
	    <div class="fitem">
	    	...
	    	<input name="applianceMarketprice" class="easyui-numberbox"  precision="2" groupSeparator="," decimalSeparator="." 
	        												prefix="￥" validType="length[0,12]"   required="required" disabled>
	    </div>

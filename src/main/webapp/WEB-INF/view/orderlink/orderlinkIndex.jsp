	...
	<div style="padding: 10px 60px 20px 60px">
		<form id="dataForm" method="post">
				...
				<div class="fitem">
		        	...
		        	<input name="linkCode" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>linkName:</label>
		        	<input name="linkName" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>linkNum:</label>
		        	<input name="linkNum" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>stage:</label>
		        	<input name="stage" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
...
<script type="text/javascript">
	...
	jQuery(function(){	  
   	...
   	$('#dataTable').datagrid({
		...
		columns:[[
							...
							{field:'linkCode',title:'linkCode',width:80},
							{field:'linkName',title:'linkName',width:80},
							{field:'linkNum',title:'linkNum',width:80},
							{field:'stage',title:'stage',width:80},
   ...
   //表格查询
	function searchInfo() {
		...
		var url = '${rootPath}/orderLink/list';
   ...
   function editrow(){    	
       ...
       if (row){
       	url = '${rootPath}/orderLink/edit?rowId='+ row.rowId;
		openWin(url);
       }
       else
       {
   ...
   function delerow(){
       ...
       if (row){
           $.messager.confirm('提示','确定要删除行记录吗？',function(r){
               if (r){
                   $.post('${rootPath}/orderLink/del',{rowId:row.rowId},function(data){

...
<div class="easyui-panel" title="XX详细信息编辑" style="width:600px">
	<form id="dataForm">
			...
			<div class="fitem">
		        ...
		        <input name="linkCode" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
			...
			<div class="fitem">
		    	<label>linkNum:</label>
		        <input name="linkNum" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>stage:</label>
		        <input name="stage" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
...
jQuery(function(){ 
	...
	if (rowId != null && rowId != "" && rowId!=0){
		var url='${rootPath}/orderLink/getOne?rowId=' + rowId;
...
function saveOrUpdate()
{
	...
	{		
		...
		$.post("${rootPath}/orderLink/save",$("#dataForm").serializeArray(),
		function(data)
		{			

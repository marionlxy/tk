...
<div class="easyui-panel" title="XX详细信息编辑" style="width:600px">
	<form id="dataForm">
			<div class="fitem">
		    	<label>mealId:</label>
		        <input name="mealId" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>orderId:</label>
			...
			<div class="fitem">
		        ...
		        <input name="mealCode" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>mealName:</label>
		        <input name="mealName" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>site:</label>
			...
			<div class="fitem">
		        ...
		        <input name="mealPrice" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>mealType:</label>
		        <input name="mealType" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>mealConte:</label>
		        <input name="mealConte" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
...
jQuery(function(){ 
	...
	if (rowId != null && rowId != "" && rowId!=0){
		var url='${rootPath}/orderMeal/getOne?rowId=' + rowId;
...
function saveOrUpdate()
{
	...
	{		
		...
		$.post("${rootPath}/orderMeal/save",$("#dataForm").serializeArray(),
		function(data)
		{			

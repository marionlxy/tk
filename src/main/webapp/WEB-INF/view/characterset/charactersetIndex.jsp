	...
	<div class="easyui-panel" title="查询条件" data-options="region:'north',height:100,collapsible:false,border : false">
		...
		<form id="dataForm111" method="post">
		      <table style="width:100%; height:1%; overflow: hidden;" border="0" 
				...
				<td>
					<input name="mealCode" class="easyui-textbox" style="width:80px">
				</td>
				<td class="kTableLabel lbl">套餐名称:</td>
				<td>
					<input name="mealName" class="easyui-textbox" style="width:80px">
				</td>
   	...
   	//初始化列表
	   	$('#dataTable').datagrid({
			...
			columns:[[
							...
							{field:'MEAL_CONTE',title:'套餐图片',width:80 , hidden:true},

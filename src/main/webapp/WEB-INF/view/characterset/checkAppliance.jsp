...
<head>
    ...
    <title>添加个性套餐用品</title>
    
</head>
<body>
<div>
	<form id="dataForm5">
		<table id="dataTable5" title="用品列表">
		</table>
		<input id="flag" type="hidden" value="${flag}"/>
		<input id="srelationId" type="hidden" value="${srelationId}"/>
...
jQuery(function(){	  
	...
	//初始化用品列表
   	$('#dataTable5').datagrid({
   		...
   		fitColumns:true,
   		height:300,
   		url : '${rootPath}/characterset/ApplianceList?site='+site,
   		method : 'post',		
...
function saveOrUpdate()
{
	...
	{	
		var srelationId = $('#srelationId').val();
		var applianceId = "";
		...
		$.post("${rootPath}/characterset/saveLinkServer?applianceId="+applianceId+"&srelationId="+srelationId,$("#dataForm5").serializeArray(),
		function(data)
		{			

...
<div>
    ...
    <div id="dlg-buttons" align="center">
       <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" id="save1" onclick="saveOrUpdate()" style="width:90px">提交</a>
...
function saveOrUpdate()
{
	...
	{		
		...
		$.post("${rootPath}/characterset/saveLink?mealId="+mealId,$("#dataForm3").serializeArray(),
		function(data)
		{			

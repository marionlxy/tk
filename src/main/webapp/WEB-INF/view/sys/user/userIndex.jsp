		...
		<form id="dataHosForm" method="post">
			<div id="condition" class="container_12" style="position: relative;">
				...
				<div class="grid_2 val"  style="width: 130px">
					...
					<div class="grid_1 lbl" style="width: 5%">用户类型:</div>
					<div class="grid_2 val" style="width: 130px">
						<input class="easyui-combobox" name="usertype" id="usertype"
							style="width: 80px" editable="editable" panelHeight="auto"
							url="${rootPath}/getDictCombox?dictType=usertype" valueField="dictId"
							textField="dictName">
					</div>
...
<!-- 				<div class="grid_1 lbl" style="width: 115px"> -->
<!--                         <a href="javascript:void(0)" class="easyui-linkbutton" -->
<!--                             iconCls="icon-page_excel" onclick="exportTable()" style="width: 85px">导出Excel</a> -->
<!--                 </div> -->
	...
	//初始化列表
   	$('#dataTable').datagrid({
		...
		columns:[[
            		...
            		{field:'User_Code',title:'登录名',width:110},
					{field:'User_Name',title:'用户姓名',width:70},

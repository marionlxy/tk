...
<div class="easyui-panel" title="XX详细信息编辑" style="width:600px">
	<form id="dataForm">
			<div class="fitem">
		    	<label>appraiseId:</label>
		        <input name="appraiseId" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>appraiseNum:</label>
		        <input name="appraiseNum" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
			...
			<div class="fitem">
		    	<label>appraiseBy:</label>
		        <input name="appraiseBy" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>appraiseMsg:</label>
		        <input name="appraiseMsg" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>appraiseType:</label>
		        <input name="appraiseType" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>subOrder:</label>
		        <input name="subOrder" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
...
jQuery(function(){ 
	...
	if (rowId != null && rowId != "" && rowId!=0){
		var url='${rootPath}/appraise/getOne?rowId=' + rowId;

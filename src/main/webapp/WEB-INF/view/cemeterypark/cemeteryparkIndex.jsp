...
<div class="easyui-panel" title="XX信息管理" style="width:805px">
	<div style="padding: 10px 60px 20px 60px">
		<form id="dataForm" method="post">
				...
				<div class="fitem">
		        	<label>cemeteryId:</label>
		        	<input name="cemeteryId" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>parkName:</label>
		        	<input name="parkName" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>parkCode:</label>
		        	<input name="parkCode" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>parkContent:</label>
		        	<input name="parkContent" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
...
<script type="text/javascript">
	...
	jQuery(function(){	  
   	...
   	$('#dataTable').datagrid({
		...
		columns:[[
							...
							{field:'cemeteryId',title:'cemeteryId',width:80},
							{field:'parkName',title:'parkName',width:80},
							{field:'parkCode',title:'parkCode',width:80},
							{field:'parkContent',title:'parkContent',width:80},
   ...
   //表格查询
	function searchInfo() {
		...
		var url = '${rootPath}/cemeteryPark/list';
   ...
   //新增
   function addrow(){
   		url = '${rootPath}/cemeteryPark/edit';
		openWin(url);
   }
   ...
   function editrow(){    	
       ...
       if (row){
       	url = '${rootPath}/cemeteryPark/edit?rowId='+ row.rowId;
		openWin(url);
       }
       else
       {
   ...
   function delerow(){
       ...
       if (row){
           $.messager.confirm('提示','确定要删除行记录吗？',function(r){
               if (r){
                   $.post('${rootPath}/cemeteryPark/del',{rowId:row.rowId},function(data){

	...
	<div style="padding: 10px 60px 20px 60px">
		<form id="dataForm" method="post">
				...
				<div class="fitem">
		        	...
		        	<input name="subState" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>subType:</label>
		        	<input name="subType" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>subPrice:</label>
		        	<input name="subPrice" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
				...
				<div class="fitem">
		        	<label>oddnum:</label>
		        	<input name="oddnum" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>logistics:</label>
		        	<input name="logistics" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>logisticsCost:</label>
		        	<input name="logisticsCost" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
...
<script type="text/javascript">
	...
	jQuery(function(){	  
   	...
   	$('#dataTable').datagrid({
		...
		columns:[[
							...
							{field:'subState',title:'subState',width:80},
							{field:'subType',title:'subType',width:80},
							{field:'subPrice',title:'subPrice',width:80},
							{field:'sellerCode',title:'sellerCode',width:80},
							{field:'sellerName',title:'sellerName',width:80},
							{field:'oddnum',title:'oddnum',width:80},
							{field:'logistics',title:'logistics',width:80},
							{field:'logisticsCost',title:'logisticsCost',width:80},
   ...
   //表格查询
	function searchInfo() {
		...
		var url = '${rootPath}/orderSub/list';
   ...
   function editrow(){    	
       ...
       if (row){
       	url = '${rootPath}/orderSub/edit?rowId='+ row.rowId;
		openWin(url);
       }
       else
       {
   ...
   function delerow(){
       ...
       if (row){
           $.messager.confirm('提示','确定要删除行记录吗？',function(r){
               if (r){
                   $.post('${rootPath}/orderSub/del',{rowId:row.rowId},function(data){

...
K.options = {
	...
	htmlTags : {
		...
		img : ['id', 'class', 'src', 'width', 'height', 'border', 'alt', 'title', 'align', '.width', '.height', '.border','max-width','max-height','style'],
		...
		video : ['expectingmoviejson', 'style', 'controls', 'preload', 'x-webkit-airplay'],
		//iframe : ['src', 'type']
	},
...
function _mediaImg(blankPath, attrs) {
	...
	//修改上传视频为h5 标签
	//srcTag的值     <embed src="/WXPro/resources/js/kindeditor/attached/media/20140919/20140919111324_541.mp4" type="video/x-ms-asf-plugin" width="550" height="400" autostart="false" loop="true" />
	if(type=='video/x-ms-asf-plugin'){//若是视频则生成h5标签
		console.log(srcTag);
		console.log('若是视频则生成h5标签-----------');
		var currsrc=(srcTag.split('src="')[1]).split('" type="')[0];
		var html='';
		console.log(currsrc);
		html ="<video expectingmoviejson='true' style='width:100%; margin-top:15px; margin-bottom:10px;' controls='controls'  preload='auto' x-webkit-airplay='allow'>" +
				"<source src='"+currsrc+"' type='video/mp4; codecs='avc1.42E01E,mp4a.40.2'' />"+
			"</video>"
	}else{

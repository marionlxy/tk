package com.taikang.iu.opt.clue.model;
...
/**
  * ClueBO 
  */
public class ClueBO  extends BaseBO {
	...
	protected void init(){
		super.init();
		this.addList(Arrays.asList("clue_id","clue_code","clue_state","custom_id","custom_name","custom_sex","custom_tel","custom_address","custom_require","door_time","invalid_reason","proxy_tel","remark","created_time","created_by","modified_time","modified_by","confirm_by","confirm_time","site","version","delflag"));
	}
	...
	private String clueState;
		...
		getData().put("clue_state",clueState);
		this.clueState=clueState;
	}
	
	public String getClueState(){
		return (String)getData().get("clue_state");
	}	
	...
	public Timestamp getConfirmTime(){
		return (Timestamp)getData().get("confirm_time");
		}

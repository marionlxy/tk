...
<div class="easyui-panel" title="XX信息管理" style="width:805px">
	<div style="padding: 10px 60px 20px 60px">
		<form id="dataForm" method="post">
				<div class="fitem">
		        	<label>mealId:</label>
		        	<input name="mealId" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>orderId:</label>
				...
				<div class="fitem">
		        	<label>site:</label>
		        	<input name="site" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>mealPrice:</label>
		        	<input name="mealPrice" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>mealType:</label>
		        	<input name="mealType" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>mealConte:</label>
		        	<input name="mealConte" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
...
<script type="text/javascript">
	...
	jQuery(function(){	  
   	...
   	$('#dataTable').datagrid({
		...
		columns:[[
							{field:'mealId',title:'mealId',width:80},
							{field:'orderId',title:'orderId',width:80},
							{field:'mealCode',title:'mealCode',width:80},
							{field:'mealName',title:'mealName',width:80},
							{field:'site',title:'site',width:80},
							{field:'mealPrice',title:'mealPrice',width:80},
							{field:'mealType',title:'mealType',width:80},
							{field:'mealConte',title:'mealConte',width:80},
   ...
   //表格查询
	function searchInfo() {
		...
		var url = '${rootPath}/orderMeal/list';
   ...
   function editrow(){    	
       ...
       if (row){
       	url = '${rootPath}/orderMeal/edit?rowId='+ row.rowId;
		openWin(url);
       }
       else
       {
   ...
   function delerow(){
       ...
       if (row){
           $.messager.confirm('提示','确定要删除行记录吗？',function(r){
               if (r){
                   $.post('${rootPath}/orderMeal/del',{rowId:row.rowId},function(data){

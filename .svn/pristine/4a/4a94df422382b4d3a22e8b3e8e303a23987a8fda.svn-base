...
public class OrderBO  extends BaseBO {
	...
	protected void init(){
		super.init();
		this.addList(Arrays.asList("seller_mobile","order_id","order_code","order_state","order_type","order_sub_type","custom_id","custom_login_name","custom_name","custom_sex","custom_tel","custom_address","custom_email","custom_type","seller_code","seller_name","angel_login_name","angel_code","angel_name","angel_tel","angel_open_id","receiver_name","receiver_postcode","receiver_phone","receiver_address","site","pay_method","invoice_state","invoice_name","invoice_content","order_price","prefer_price","settle_price","oddnum","logistics","logistics_cost","appraise_state","pay_by","pay_time","cancel_by","cancel_time","create_sub_by","create_sub_time","send_by","send_time","edit_send_by","edit_send_time","take_by","take_time","reject_by","reject_time","refund_by","refund_time","complete_by","complete_time","created_time","created_time1","created_by","modified_time","modified_by","version","delflag","subCode","proxyTel","employeeName"));
	}
	
	private String subCode;
	public void setSubCode(String subCode) {
		getData().put("subCode",subCode);
		this.subCode = subCode;
	}
	public String getSubCode() {
		return (String)getData().get("subCode");
	}
	private String sellerMobile;
	public void setSellerMobile(String sellerMobile) {
		getData().put("seller_mobile",sellerMobile);
		this.sellerMobile = sellerMobile;
	}
	public String getSellerMobile() {
		return (String)getData().get("seller_mobile");
	}
    private String proxyTel;
	public String getProxyTel() {
		return (String)getData().get("proxyTel");
	}
	public void setProxyTel(String proxyTel) {
		getData().put("proxyTel",proxyTel);
		this.proxyTel = proxyTel;
	}
	
    private String employeeName;
	public String getEmployeeName() {
		return (String)getData().get("employeeName");
	}

	public void setEmployeeName(String employeeName) {
		getData().put("employeeName",employeeName);
	...
	private Timestamp createdTime1;
	public void setCreatedTime1(Timestamp createdTime1){
	getData().put("created_time1",createdTime1);
	this.createdTime1=createdTime1;
	}
	
	public Timestamp getCreatedTime1(){
		return (Timestamp)getData().get("created_time1");
	}	

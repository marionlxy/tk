...
jQuery(function(){	  
	...
	//初始化用品列表
 	$('#dataTable16').datagrid({
   		...
   		pagination:true,
   		fitColumns:true,
   		url:'${rootPath}/characterset/serviceList?site='+site,
   		method : 'post',		
...
function saveOrUpdate3()
{
	...
	{	
		...
		$.post("${rootPath}/characterset/saveLinkService?serviceId="+serviceId+"&linkId="+linkId,$("#dataForm16").serializeArray(),
		function(data)
		{			

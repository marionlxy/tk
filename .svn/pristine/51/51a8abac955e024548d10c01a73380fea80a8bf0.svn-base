...
<script type="text/javascript">
	...
	function showdetail() {
	    ...
	    if (row) {
	        url = '${rootPath}/log/show?rowId=' + row.Log_ID;
	        $("#divDialog").dialog({
	            title : "日志详细信息",
	            width : 450,
	            height : 450,
   ...
   //表格查询
	function searchInfo() {
		...
		var url = '${rootPath}/log/querylist';

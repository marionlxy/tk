...
<div>
    ...
    <div id="dlg-buttons" align="center">
       <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" id="save" onclick="saveOrUpdate()" style="width:90px">上架</a>
...
function saveOrUpdate()
{
	...
	{		
		...
		$.post("${rootPath}/single/saveShelves",$("#dataForm").serializeArray(),
		function(data)
		{			

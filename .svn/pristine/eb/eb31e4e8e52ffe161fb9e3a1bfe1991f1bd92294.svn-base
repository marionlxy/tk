package com.taikang.iu.opt.characterset.model;
...
/**
  * CharactersetBO 
  */
public class CharactersetBO  extends BaseBO {
	
	private static final long serialVersionUID = 1L;
	
	public CharactersetBO(){
		init();
	}
	
	protected void init(){
		super.init();
		this.addList(Arrays.asList("meal_picture","appliance_id","category_id","quality_value_id","skuid","category_name","appliance_coding","appliance_name","seller_name","appliance_settle_price","appliance_marketprice","interflow_price","is_return_bills","appliance_unit","appliance_category_id","ismarketable","srelation_id","relation_id","service_id","service_num","service_name","link_id","link_code","link_name","link_num","stage","meal_id","meal_code","meal_name","meal_type","meal_price","meal_conte","site","meal_picture","state","created_time","created_by","modified_time","modified_by","version","delflag"));
	}
	...
	public void setSkuid(String skuid){
		getData().put("skuid",skuid);
		this.skuid=skuid;
	}

	public String getSkuid(){
		return (String)getData().get("skuid");
	}	
	...
	private String srelationId;
	public void setSrelationId(String srelationId){
		getData().put("srelation_id",srelationId);
		this.serviceId=srelationId;
	}
	
	public String getSrelationId(){
		return (String)getData().get("srelation_id");
	}
	...
	private String mealPicture;
		...
		getData().put("meal_picture",mealPicture);
		this.mealPicture=mealPicture;
	}
	
	public String getMealPicture(){
		return (String)getData().get("meal_picture");
	}	

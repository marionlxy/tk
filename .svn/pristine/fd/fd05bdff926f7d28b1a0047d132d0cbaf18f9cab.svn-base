...
<div class="easyui-panel" title="查询条件" data-options="region:'north',height:120,collapsible:false,border : true" style="overflow: hidden;">
		    ...
		    <br/>
				...
				<div class="grid_1 lbl" style="float:left;" >客户电话:</div>
					...
					<div class="grid_1 lbl" >结束时间:</div>
						...
						<div class="grid_2 val">
						<input class="easyui-combobox"   name="angelName" editable="editable"  style="width:100px;" panelHeight="auto"
...
<script type="text/javascript">
	...
	jQuery(function(){	  
   	...
   	var dictList = getDictList('WORKSHEET_STATUS');
   	$('#dataTable').datagrid({
   		iconCls:'icon-tip',
   		singleSelect : true,
   		rownumbers:true,
